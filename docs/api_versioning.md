...
- [データベーススキーマガイドライン](api-versioning-database-guidelines.md) - DB変更時の互換性管理
- [ディレクトリ構造ガイドライン](api-versioning-directory-structure.md) - バージョン別ファイル配置
- [Hono API 実装標準](server_standards.md) - サーバーサイド実装標準
- [API 設計ガイドライン](api_design_guidelines.md) - API設計の原則
